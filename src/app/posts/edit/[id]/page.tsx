    ...
    const fetchPost = async () => {
      ...
      try {
        ...
        Swal.fire({
          icon: 'error',
          title: 'Gagal Memuat',
          text: 'Postingan yang ingin Anda edit tidak dapat ditemukan.',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await Swal.fire({
        ...
        text: 'Postingan Anda telah berhasil disimpan.',
        timer: 2000,
      ...
      if (error.response?.status === 422) {
        ...
        Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'Gagal memperbarui postingan. Silakan coba lagi.',
            background: 'var(--base-100)',
            color: 'var(--foreground)',
            customClass: { popup: 'rounded-xl shadow-lg' }
        });
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-blue-900 dark:to-indigo-900">
        ...
        <div className="flex justify-center items-center min-h-[70vh]">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-lg font-medium">Memuat data postingan...</p>
          </div>
        </div>
      </div>
    );
          ...
          <form onSubmit={handleSubmit} noValidate>
            <div className="p-8 border-b border-gray-100 dark:border-gray-700">
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div>
                  <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">Mode Penyuntingan</p>
                  <p className="text-sm text-gray-400 dark:text-gray-500">Perbarui dan sempurnakan karyamu</p>
                </div>
              </div>
